    ...
    <>
      <div className="info">
        ...
        <div className="info-bar">
          ...
          <Link className = "info-link" to={{ pathname: "https://instagram.com/zaverot"}} target= "_blank">GitHub</Link>
          <Link className = "info-link" to={{ pathname: "https://instagram.com/zaverot"}} target= "_blank">LinkedIn</Link>
          <Link className = "info-link" to={{ pathname: "https://instagram.com/zaverot"}} target= "_blank">Spotify</Link>
        </div>
      </div>
